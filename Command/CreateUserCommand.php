...
namespace SoftPassio\UserBundle\Command;

use SoftPassio\Components\Model\UserInterface;
use SoftPassio\UserBundle\Doctrine\UserManager;
use SoftPassio\UserBundle\Entity\User;
...
class CreateUserCommand extends Command
{
    ...
    {
        $this
            ->setName('softpassio:user:create')
